		...
		<div class="tab_wa">
			<div class="tab">
				<div class="flwtab" id="flwtab2">
					<a href="otherfdisp?oid=<%=request.getAttribute("userId") %>"><span>フォロー</span></a>
				</div>
				<div class="flwtab" id="flwtab1">
					<a href="otherfdisp2?oid=<%=request.getAttribute("userId") %>"><span>フォロワー</span></a>
				</div>
			</div>
		</div>
	</nav>
	<div class="tab_screen">
		<% ArrayList<HashMap<String, String>> flw = (ArrayList<HashMap<String, String>>)request.getAttribute("flwer"); %>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div id="follower" role="tabpanel" class="tab-pane">
							<% ArrayList<HashMap<String, String>> flw4 = (ArrayList<HashMap<String, String>>)request.getAttribute("flwer2"); %>
