...
<script src="https://kit.fontawesome.com/d16ddb49b7.js" crossorigin="anonymous"></script>
</head>
<body>
	...
	<div class="tw_in">
		<p><a href="account"><span><%= request.getAttribute("userId") %></span></a></p>
		<form action="follow" method="post">
			<textarea maxlength="100" name="tweet" placeholder="今日はなにがあった？"></textarea>
			<button id="submit" type="submit">
				<img src="img/airplane.png" alt="飛行機">
			</button>
		</form>
	</div>
	...
	<div class="tw_all">
		...
		<div class="tw_list">
			<p id="user">
				<a href="otherac?other_uId=<%= log.get("userId") %>"><span class="u<%= i %>"><%= log.get("userId") %></span></a>
			</p>
			<p id="text" class="t<%= i %>"><%= log.get("tweet") %></p>
			<div class="tw_others">
				<p id="heart"><i class="fas fa-heart fa-lg color<%= i %>" data-id="<%= i %>"></i></p>
				<p id="date" class="d<%= i %>"><%= log.get("tmStamp") %></p>
			</div>
		</div>
		<% i+=1; %>
		<%} %>
