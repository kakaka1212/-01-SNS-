...
<body>
	...
	<div class="tw_profile">
		...
		<div class="pro_up">
			<p><a href="update">プロフィールを編集</a></p>
		</div>
		<div class="name">
			<p class="Name1"><span class="under"><%= request.getAttribute("name") %></span></p>
			<p class="Name2"><%= request.getAttribute("userId") %></p>
		</div>
		<div class="pro_details">
			<p><%= request.getAttribute("self") %></p>
			<p><%= request.getAttribute("startMn") %>からついっとを利用しています</p>
			<div class="f_people">
				<p><a href="fdisp?id=0"><%= request.getAttribute("follow_p") %>フォロー中</a></p>
				<p><a href="fdisp?id=1"><%= request.getAttribute("follower_p") %>フォロワー</a></p>
			</div>
		</div>
	</div>
	<!-- ついっと一覧 -->
	<div class="twp_all">
		...
		<div class="tw_list">
			<p id="user">
				<a href="otherac?other_uId=<%= log.get("userId") %>"><span class="under"><%= log.get("userId") %></span></a>
			</p>
